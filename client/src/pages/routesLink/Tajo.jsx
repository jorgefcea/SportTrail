...
const Tajo = () => {
  ...
  useEffect(() => {
    ...
    new L.GPX("../src/pages/routesLink/gpx/tajo.gpx", {
      async: true
                ...
                <section className="promos container" id="lista-1">
                  ...
                  <canvas id="altitudeChart"></canvas>
                    ...
                    <section className="promos container" id="lista-1">
                        ...
                        <hr />
                        <p className="descripcion">Preciosa ruta alrededor de la maravillosa e impresionante localidad de Ronda, con su famoso puente de 98 metros de altura llamado "Puente Nuevo", finalizado en 1793. <br /><br />Este sendero conduce por un bonito y tranquilo sendero lleno de casas rurales donde en cada esquina se tiene una panorámica más bonita que la anterior.</p>
                    </section>
                    ...
                    <section className="promos container" id="lista-1">
                      ...
                      <div className="imageGallery">
                          <div className="horizontalImages">
                              <img src="../src/pages/routes/routesImg/tajo1.png" alt="Imagen 1" />
                              <img src="../src/pages/routes/routesImg/tajo2.png" alt="Imagen 2" />
                          </div>
                          <div className="verticalImage">
                              <img src="../src/pages/routes/routesImg/tajo3.png" alt="Imagen 3" />
                          </div>
                      </div>
                  </section>
                </div>
