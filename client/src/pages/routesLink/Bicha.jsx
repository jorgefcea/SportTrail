...
const Bicha = () => {
  ...
  useEffect(() => {
    ...
    new L.GPX("../src/pages/routesLink/gpx/bicha.gpx", {
      async: true
                ...
                <section className="promos container" id="lista-1">
                  ...
                  <canvas id="altitudeChart"></canvas>
                    ...
                    <section className="promos container" id="lista-1">
                        ...
                        <hr />
                        <p className="descripcion">Bonito y tranquilo paseo a las orillas del río Genil. <br /><br />El recorrido empieza cerca de la Plaza Escultor Francisco López Burgos y sigue la orilla Sur del Río Genil pasando por el Parque Bola de Oro. <br /><br />Más tarde se pasa por la Lancha del Genil y se llega cerca de Cenes de la Vega.</p>
                    </section>
                    ...
                    <section className="promos container" id="lista-1">
                      ...
                      <div className="imageGallery">
                          <div className="horizontalImages">
                              <img src="../src/pages/routes/routesImg/bicha1.png" alt="Imagen 1" />
                              <img src="../src/pages/routes/routesImg/bicha2.png" alt="Imagen 2" />
                          </div>
                          <div className="verticalImage">
                              <img src="../src/pages/routes/routesImg/bicha3.png" alt="Imagen 3" />
                          </div>
                      </div>
                  </section>
                </div>
