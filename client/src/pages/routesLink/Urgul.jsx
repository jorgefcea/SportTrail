...
const Urgul = () => {
  ...
  useEffect(() => {
    ...
    new L.GPX("../src/pages/routesLink/gpx/urgul.gpx", {
      async: true
    ...
    <div className="routes">
            <div className="routesContainer">
                <div className="routesInfo">
                  <h1>Monte Urgull - Castillo de la Mota<br />
                    <span>(San Sebastián, Guipúzcoa, España)</span>
                  </h1>
                ...
                <section className="promos container" id="lista-1">
                  ...
                  <canvas id="altitudeChart"></canvas>
                    ...
                    <section className="promos container" id="lista-1">
                        ...
                        <hr />
                        <p className="descripcion">Este maravilloso y agradable paseo comienza a los pies del Monte Urgull, una montaña que se encuentra entre la Parte Vieja de San Sebastián y el paseo Nuevo, junto al mar Cantábrico. <br /><br />El inicio del sendero comienza en el casco antiguo de la ciudad de San Sebastián -o Donostia, en euskera,- y tiene como destino el Castillo de la Mota, una fortaleza coronada con una enorme estatua de Jesús que se puede ver desde la mayor parte de la ciudad.</p>
                    </section>
                    ...
                    <section className="promos container" id="lista-1">
                      ...
                      <div className="imageGallery">
                          <div className="horizontalImages">
                              <img src="../src/pages/routes/routesImg/urgul1.png" alt="Imagen 1" />
                              <img src="../src/pages/routes/routesImg/urgul2.png" alt="Imagen 2" />
                          </div>
                          <div className="verticalImage">
                              <img src="../src/pages/routes/routesImg/urgul3.png" alt="Imagen 3" />
                          </div>
                      </div>
                  </section>
                </div>
